params [
    ["_container", objNull, [objNull]], ["_target", "", [""]], ["_kitId", "", [""]], ["_operation", "ADD", [""]],
    ["_policy", "BEST_EFFORT", [""]], ["_context", createHashMap, [createHashMap]], ["_options", createHashMap, [createHashMap]]
];
private _sourceR = [_kitId] call ServoPeregrino_Organizador_Items_fnc_getSavedKitApplicationSource;
